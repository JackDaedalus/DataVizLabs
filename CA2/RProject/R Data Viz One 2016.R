...
#
# The 2016 division of metrpolitan areas is slightly different to
# the categrisation in the 2011 census
#
# ----------------------------------------------------------------#
...
# Using cut to create 2016 categorical bands for rates of unemployment
