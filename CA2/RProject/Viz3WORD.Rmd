...
# Additional packages to improve information display
# on scatter plot graphs
...
for (i in 1:(length(arrCensusThemeFiles))) {
  ...
  if (arrCensusThemeYears[i] == '2011') { # The 2011 Census Theme columns for 
    ...
    # Correct for Irish language fada in Dun-Laoighaire throwing a text error
  ...
  # ------------------------------------------------------------------#
  # Data manipulation routines to add calculated field for 
